...
const RoleTable = () => {
  ...
  const deleteData = (id: any) => {
    const subscription = post(ROLE_URLS.DELETE, { id: id }).subscribe(
      (response) => {
    ...
    let alertProps: SmartLoaderInterface.SmartAlertInterface = {
      title: (
        <span className="has-text-danger">
          <i className="fa fa-check"></i> Role Deletion!
        </span>
      ),
      ...
      content: (
        <p>
          Note: Do you wish to delete this Role? This action cannot be reverted
        </p>
      ),
